...
const strengths = [
  ...
  },
  {
    ...
    body: 'We work closely with traffic management companies and civil contractors who need reliable workers ready to step onto site.',
  },
  {
    icon: <ShieldCheck size={28} strokeWidth={1.5} aria-hidden="true" />,
    title: 'Quality and Reliability',
    body: 'Our workers are selected for reliability, attitude and the ability to support crews when extra hands are needed.',
  },
]
      ...
      <section style={{ background: '#111', padding: 'clamp(60px, 8vw, 100px) 24px' }}>
        <div style={{ maxWidth: '1152px', margin: '0 auto' }}>
          <h2 className="font-display" style={{
            ...
            Built Around the Needs of Traffic Management Crews
          </h2>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '1280px', margin: '0 auto', padding: '72px 24px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '14px' }}>
            ...
            <a href="/find-work" className="hero-btn-secondary">Apply for Work</a>
          </div>
        </div>
      </section>
